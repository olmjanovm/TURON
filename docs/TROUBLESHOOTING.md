...
-   **Solution**: Verify `VITE_MAP_API_KEY` in the frontend `.env`. If the key is missing, the Mini App falls back to demo map mode and disables Yandex address search/routing.
