...
export const ORDER_TRACKING_STEPS: StatusStep[] = [
  { id: OrderStatus.PENDING, label: 'Yaratildi', description: 'Buyurtmangiz qabul qilindi' },
  {
    ...
    label: 'Tasdiqlandi',
    description: 'Restoran buyurtmani tasdiqladi va tayyorlashni boshladi',
  },
  {
    id: OrderStatus.READY_FOR_PICKUP,
    label: 'Tayyor',
    description: 'Taom tayyor, kuryerga topshirilmoqda',
  },
  {
    id: OrderStatus.DELIVERING,
    label: 'Yetkazilmoqda',
    description: 'Buyurtmangiz manzilga qarab yo\'lga chiqdi',
  },
