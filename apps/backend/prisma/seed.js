...
async function main() {
    ...
    await prisma.user.upsert({
        ...
        create: {
            ...
            firstName: 'Admin',
            lastName: 'Turon',
            language: shared_1.LanguageEnum.UZ,
            roles: { create: { role: shared_1.UserRoleEnum.ADMIN } },
        },
    });
    await prisma.user.upsert({
        ...
        create: {
            ...
            language: shared_1.LanguageEnum.UZ,
            roles: { create: { role: shared_1.UserRoleEnum.COURIER } },
        },
    });
    await prisma.user.upsert({
    ...
    await prisma.promoCode.createMany({
        data: [
            {
                code: 'WELCOME2026',
                discountType: shared_1.PromoDiscountTypeEnum.PERCENTAGE,
                discountValue: 10,
            ...
            {
                code: 'TURON_FIXED',
                discountType: shared_1.PromoDiscountTypeEnum.FIXED_AMOUNT,
                discountValue: 20000,
