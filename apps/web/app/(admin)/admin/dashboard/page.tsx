...
const STATUS_META: Record<string, { label: string; dot: string }> = {
  [OrderStatusEnum.PENDING]: { label: 'Yangi', dot: 'bg-blue-500' },
  [OrderStatusEnum.PREPARING]: { label: 'Tayyorlanmoqda', dot: 'bg-amber-500' },
  [OrderStatusEnum.READY_FOR_PICKUP]: { label: 'Tayyor', dot: 'bg-indigo-500' },
  [OrderStatusEnum.DELIVERING]: { label: "Yo'lda", dot: 'bg-violet-500' },
  [OrderStatusEnum.DELIVERED]: { label: 'Yetkazildi', dot: 'bg-emerald-500' },
  [OrderStatusEnum.CANCELLED]: { label: 'Bekor', dot: 'bg-rose-500' },
};

function money(o: { finalAmount?: number; totalAmount?: number }): number {
